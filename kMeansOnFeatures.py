...
def getQuestionClasses(auto_f, volunteers, question, seed):
    ...
    pred_results = KMeans(n_clusters=len(fcol_names), random_state=seed).fit_predict(valid_feats)
...
report_df.to_csv("/users/ezraf/clusterResults/kmeans_accuracy.csv")
time_df.to_csv("/users/ezraf/clusterResults/kmeans_time.csv")